...
// Trip kinds, and their badge labels. 'none' is a TRIP-typed activity that carried zero legs on this
// occasion — a school day the child never left home, a camp week the bus collected her, teletherapy.
// It keeps the event's real activity type instead of misfiling it as caregiving, and reads as an
// affirmative "no transport occurred" on the report rather than a blank field. Note a non-trip
// (caregiving) row is a different thing: it stores the inert filler 'dropoff' and always will —
// see CLAUDE.md, that filler can never be migrated away without breaking every prior month seal.
export const PD = { dropoff: 'DROP', pickup: 'PICK', both: 'BOTH', none: 'NONE' };
